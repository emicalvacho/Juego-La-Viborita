...
namespace SocketCliente
{
    ...
    /// </summary>
    public partial class Tablero_Principal_Cliente : Tablero_Principal
    {
        #region Atributos
        ...
        /// </summary>
        public Tablero_Principal_Cliente()
        {
            InitializeComponent();
            enviar = new Enviar();
            escuchar = new Escuchar();
            tableroConexion = new Tablero_Conexion("del Equipo Azul");
            escuchar.Comenzar(3000);
        ...
        /// al puerto 4000 para que el cliente pueda recibir la información.
        ...
        public void RecibirInformacion(Serializador respuesta)
        {
            ...
            {
                Console.WriteLine("Turno del cliente");
                jugador.Turno = 1;
        ...
        #region Botones
        /// <summary>
        /// Envío la información por el puerto 4000
        /// </summary>
        ...
        /// <summary>
        /// Determino el turno inicial pero si son iguales la cantidad de fichas el turno no es
        /// del Equipo Azul
        /// </summary>
        ...
        /// <summary>
        /// Envío por el puerto 4000 el turno al jugador cuando su adversario se quedó sin fichas
        /// </summary>
        ...
        public override void rakingToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            Tablero_Ranking tablero_Ranking = new Tablero_Ranking("del Equipo Azul");
        ...
        public override void finalizarJuegoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (jugador.Turno == 1)
            {
                DialogResult dr = MessageBox.Show("¿Deseas retirarte del juego?", "Plantarse", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation);
